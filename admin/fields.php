...
function whatsapp_button_animation_load_callback()
{
  ...
  <div id="animation_preview_load" class="preview_box" min="50" max="120"><i class="fa-brands fa-whatsapp"
      style="font-size: <?php echo esc_attr($icon_size) ?>px" min="30" max="100"></i></div>
  <?php
}
...
function whatsapp_button_animation_hover_callback()
{
  ...
  <div id="animation_preview_hover" class="preview_box" min="50" max="120"><i class="fa-brands fa-whatsapp"
      style="font-size: <?php echo esc_attr($icon_size) ?>px" min="30" max="100"></i></div>
  <?php
}
...
function whatsapp_button_clickid_callback()
{
  ...
  echo '<input type="text" name="whatsapp_button_clickid" value="' . esc_attr($clickid) . '" class="form-control w-50" placeholder="Ej: google-cpc-2021" />';
  echo '<small class="form-text text-muted d-block mt-2">Este valor se anadirá al final de la URL de WhatsApp para tracking.</small>';
}
